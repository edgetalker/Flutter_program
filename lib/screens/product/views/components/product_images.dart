...
class _ProductImagesState extends State<ProductImages> {
  late PageController _controller;// 页面控制器

  int _currentPage = 0;// 当前页码

  @override
  void initState() {
    _controller = PageController(viewportFraction: 0.9, initialPage: _currentPage);// 初始化页面控制器
    super.initState();
  }
